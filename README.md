...
## Clojure
  ...
  - [dakrone/clj-http](https://github.com/dakrone/clj-http) - An idiomatic clojure http client wrapping the apache client. Officially supported version. \[*MIT License*\] (⭐️1798)
